...
private:
  void init_collision(Registery::Entity const& entity, JsonObject const& obj);
  void init_interaction_zone(Registery::Entity const& entity,
                             JsonObject const& obj);

  void collision_system(Registery& r,
                        const SparseArray<Position>& positions,
                        const SparseArray<Collidable>& collidables);
  void interaction_zone_system(Registery& r,
                        const SparseArray<Position>& positions,
