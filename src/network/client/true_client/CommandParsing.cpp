...
std::optional<ConnectedPackage> Client::parse_connected_package(ByteArray const& package)
{
...
std::optional<ConnectedCommand> Client::parse_connected_command(ByteArray const &package) {
...
std::optional<EventBuilder> Client::parse_event_build_cmd(ByteArray const &package) {
...
std::optional<ComponentBuilder> Client::parse_component_build_cmd(ByteArray const &package) {
