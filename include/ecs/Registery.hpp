...
class Registery {
    ...
    SparseArray<Component> &registerComponent() {
        this->components_.insert_or_assign(std::type_index(typeid(Component)), SparseArray<Component>());
    ...
    SparseArray<Component> &getComponents() {
        return std::any_cast<SparseArray<Component> &>(this->components_.at(std::type_index(typeid(Component))));
    }
    ...
    typename SparseArray<Component>::ref add_component(Entity const &to, Component &&c) {
        return this->getComponents<Component>().insert_at(to, c);
    }

    template<typename Component, typename ...Params>
    typename SparseArray<Component>::ref emplace_component(Entity const & to, Params &&...p) {
    ...
    void addSystem(Function && f) {
        this->frequent_systems_.push_back([this, f]() {f(*this, this->getComponents<Components>()...);});
    }
