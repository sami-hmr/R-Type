...
```
0x67676767 0x04 <protocol_version> <challenge> <player_name> 0x00
```

Arguments:
- protocol_version: 8-bits integer (current version is 1)
- challenge: 32-bits integer (from challengeResponse) (4-bytes)
- player_name: 256-bits string (32-bytes)

Total: 296-bits (37-bytes)

Example: `0x67676767 0x04 1 2847561 toto 0x00`
...
```
0x67676767 0x05 <value1> <value2>... 0x00
```

Required keys:
- hostname: Server display name (512-bits) (64 bytes)
- mapname: Current map identifier (256-bits) (32 bytes)
...
Player info format:
- score: Score (32-bits integer) (= 4-bytes)
- ping:  Ping in milliseconds (8-bits integer) (= 1-byte)
- name:  Player name (max 256-bits) (= 32-bytes)

Total Player info format: 72-bits
Total Format: 72-bits + 792-bits (864-bits)
...
Example: `0x67676767 0x09 "protocol version mismatched" 0x00`
